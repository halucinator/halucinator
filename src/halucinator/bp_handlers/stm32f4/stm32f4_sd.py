...
class SD_Card(BPHandler):
    ...
    def return_hal_ok(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
    ...
    def erase_blocks(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
        print("SD_CARD Erase block")
        return True, 0

    # HAL_StatusTypeDef HAL_SD_GetCardCID(SD_HandleTypeDef *hsd, HAL_SD_CardCIDTypeDef *pCID)
    @bp_handler(['HAL_SD_Erase'])
    def get_card_CID(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
        print("SD_CARD CID")
        return True, 0

    # HAL_StatusTypeDef HAL_SD_GetCardCSD(SD_HandleTypeDef *hsd, HAL_SD_CardCSDTypeDef *pCSD)
    @bp_handler(['HAL_SD_GetCardCSD'])
    def get_card_CSD(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
        pCSD = qemu.regs.r1
    ...
    def get_card_status(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
    ...
    def get_card_info(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
    ...
    def config_wide_bus(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
        print("SD_CARD config bus operation")
        return True, 0

    # HAL_SD_CardStateTypeDef HAL_SD_GetCardState(SD_HandleTypeDef *hsd)
    @bp_handler(['HAL_SD_GetCardState'])
    def get_card_state(self, qemu: HALQemuTarget, bp_addr: int) -> HandlerReturn:
