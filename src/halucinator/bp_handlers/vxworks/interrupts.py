...
class Interrupts(BPHandler):
    ...
    """
    prev: str = ''
    def __init__(self, model: Type[InterruptModel] = InterruptModel, mask: Optional[int] = None,
                int_connect_log: str = 'tmp/intConnect.log', level: int = 2) -> None:
        BPHandler.__init__(self)
        self.model: Type[InterruptModel] = model  # This where the bp_handler gets a reference to
                            # the interrupts model
        self.int_connect_log: str = int_connect_log
