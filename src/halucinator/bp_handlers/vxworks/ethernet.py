...
class Ethernet(BPHandler):
    ...
    def net_pool_init(self, qemu: "HalBackend", addr: int) -> Tuple[bool, None]:  # pylint: disable=unused-argument,no-self-use
        """
        net_pool_init
        """
    ...
    def get_eth_id(self, qemu: "HalBackend") -> str:  # pylint: disable=unused-argument,no-self-use
        """
        get_eth_id
        """
    ...
    def e_io_cs_addr(
        self, qemu: "HalBackend", p_obj: int, ptr_mac_addr: int
    ...
    def get_packetdata(self, qemu: "HalBackend", mblk: int) -> Dict[str, Any]:  # pylint: disable=no-self-use,no-self-use
        """
    ...
    @bp_handler(["xSend"])
    def x_send(self, qemu: "HalBackend", bp_addr: int) -> Tuple[bool, int]:  # pylint: disable=unused-argument
        """
    ...
    @bp_handler(["xUnload"])
    def x_unload(self, qemu: "HalBackend", bp_addr: int) -> Tuple[bool, int]:  # pylint: disable=unused-argument,no-self-use
        """
        xUnload bp_handler
        """
        log.debug("x_unload")
    ...
    @bp_handler(["xIoctl"])
    def x_ioctl(self, qemu: "HalBackend", bp_addr: int) -> Tuple[bool, int]:  # pylint: disable=unused-argument
        """
    ...
    @bp_handler(["xStart"])
    def x_start(self, qemu: "HalBackend", bp_addr: int) -> Tuple[bool, int]:  # pylint: disable=unused-argument
        """
        Xstart  bp_handler
        """
        log.debug("x_start")
    ...
    @bp_handler(["xLoad"])
    def x_load(self, qemu: "HalBackend", bp_addr: int) -> Tuple[bool, int]:  # pylint: disable=unused-argument,no-self-use
        """
        xLoad bp_handler
        """
        log.debug("x_load")
    ...
    def handle_end_int_rcv(self, qemu: "HalBackend", bp_addr: int) -> Any:  # pylint: disable=unused-argument
        """handle_end_int_rcv"""
    ...
    def set_mblk(self, qemu: "HalBackend", mblk_addr: int, data: bytes, flags: int = 3) -> None:
        """set_mblk"""
    ...
    def get_mblk(self, qemu: "HalBackend", bp_addr: int) -> Any:  # pylint: disable=unused-argument
        """get_mblk"""
        m_blk = qemu.regs.r0
        if m_blk == 0:
    ...
    def receive_done(self, qemu: "HalBackend", bp_addr: int) -> Tuple[bool, None]:  # pylint: disable=unused-argument
        """receive_done"""
        log.debug(
